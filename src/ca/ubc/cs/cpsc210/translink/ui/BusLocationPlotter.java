    ...
    public void plotBuses() {
        ...
        if (!(selected == null)) {
            ...
            for (Bus bus : buses) {
                ...
                LatLon busLocation = bus.getLatLon();

                GeoPoint busGeoPoint = new GeoPoint(busLocation.getLatitude(), busLocation.getLongitude());
                OverlayItem overlayItem = new OverlayItem(bus.getDestination(), bus.getTime(), busGeoPoint);
